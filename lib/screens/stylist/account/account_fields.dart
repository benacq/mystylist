      ...
      children: [
        ...
        GetBuilder<SharedController>(builder: (state) {
          return AccountData(
            ...
            handlerButton: GestureDetector(
              onTap: () {
                FormState formState = SharedController.formKeys[1].currentState;
                if (formState.validate()) {
                  formState.save();
                  if (!contact.isNull && contact != widget.model.contact) {
                    state.updateSingleData(1, "contact", contact).then((value) {
                      if (value == true) {
                        Fluttertoast.showToast(msg: "Updated");
                        return;
                      }
        ...
        GetBuilder<SharedController>(builder: (state) {
          return AccountData(
            ...
            handlerButton: GestureDetector(
              onTap: () {
                FormState formState = SharedController.formKeys[2].currentState;
                if (formState.validate()) {
                  formState.save();
